            ...
            <div class="offcanvas-body" style="max-height: 50rem;">
                <article v-for="(club, index) in filteredClubs" :key="index"
                    ...
                    <div class="col-sm-4 bg-repeat-0 bg-size-cover bg-position-center rounded-5"
                        :style="{ backgroundImage: `url(${club.clubImgUrl})` }">
                    </div>
                    ...
                    <div class="col d-flex flex-column ms-3 pt-1 pb-1">
                        ...
                        <div class="d-flex align-items-center flex-wrap ps-sm-4 pe-lg-4" style="flex: 1;">
                            <span class="rounded-circle bg-size-cover bg-position-center flex-shrink-0"
                                :style="{ backgroundImage: `url(${club.memberImgUrl})`, width: '40px', height: '40px' }"></span>
                            <span class="ms-3 fs-sm">{{ club.nickname }}</span>
...
const clubs = ref([
    {
        ...
        nickname: '러닝요정',
        memberImgUrl: 'assets/img/avatar/01.jpg',
        sport: '러닝',
        location: '수원 영통구'
    },
    {
        ...
        clubImgUrl: 'assets/img/blog/list/02.jpg',
        nickname: '슬램덩커',
        memberImgUrl: 'assets/img/avatar/12.jpg',
        sport: '농구',
        location: '서울 마포구'
    },
    {
        ...
        nickname: '라켓의정석',
        memberImgUrl: 'assets/img/avatar/08.jpg',
        sport: '테니스',
        location: '서울 강서구'
    },
    {
        ...
        clubImgUrl: 'assets/img/blog/list/04.jpg',
        nickname: '마운틴러버',
...
const filteredClubs = computed(() => {
    if (selectedAuthor.value === 'all') {
        ...
        return clubs.value.filter(club => club.nickname === currentUser.value);
